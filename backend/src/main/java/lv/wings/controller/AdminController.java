...
public class AdminController {
	...
	// @PostMapping(value = "products/create", consumes =
	// MediaType.MULTIPART_FORM_DATA_VALUE)
	// public ResponseEntity<ApiResponse<?>> postCreateProduct(@Valid @RequestPart
	...
	// return ResponseEntity.status(HttpStatus.CREATED).body(new
	// ApiResponse<>("Prece izveidota!", null));
	// } catch (Exception e) {
	// System.out.println(e.getMessage());
	// return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
	// .body(new ApiResponse<>("Kļūda: " + e.getMessage(), null));
	...
	// @PostMapping(value = "products-pictures/create-delete", consumes =
	// MediaType.MULTIPART_FORM_DATA_VALUE)
	...
	// productsPictureService.retrieveById(pictureId);
	// productsPictures.remove(productPicture);
	// Path deleteImagePath = Paths.get(uploadProductsDir,
	// productPicture.getReferenceToPicture());
	// Files.deleteIfExists(deleteImagePath);
	// }
	// }
	...
	// ProductPicture newProductPicture = new ProductPicture(uniqFileName,
	// "apraksts", product);
	...
	// public ResponseEntity<ApiListResponse<EventCategoryDTO>>
	...
	// productsCategoryService.retrieveAll();
	...
	// List<EventDTO> eventsDTO = DTOMapper.mapMany(EventDTO.class,
	// allEvents.toArray(),
	// new String[] { "eventCategory", "location", "startDate", "endDate",
	...
	// List<ProductDTO> productsDTO = DTOMapper.mapMany(ProductDTO.class,
	// allProducts.toArray(),
	// new String[] { "productCategory", "purchaseElement", "description", "price",
	// "amount",
	...
	// public ResponseEntity<ApiResponse<EventCategory>>
	...
	// return ResponseEntity.ok(new ApiResponse<EventCategory>(null,
	// eventCategory));
	// } catch (NoContentException e) {
	...
	// public ResponseEntity<ApiResponse<ProductCategory>>
	// deleteProductCategory(@PathVariable int id) {

	// try {
	// ProductCategory productCategory = productsCategoryService.retrieveById(id);
	// productsCategoryService.deleteById(id);

	// return ResponseEntity.ok(new ApiResponse<ProductCategory>(null,
	// productCategory));
	// } catch (NoContentException e) {
	...
	// public ResponseEntity<ApiResponse<Product>> deleteProduct(@PathVariable int
	// id) {
	// try {
	// Product product = productsService.retrieveById(id);
	...
	// public ResponseEntity<ApiResponse<?>> updateEventCategory(@PathVariable int
	// id,
	// @Valid @RequestBody EventCategoryDTO eventCategory,
	// BindingResult result) {
	...
	// public ResponseEntity<ApiResponse<?>> updateProductCategory(@PathVariable int
	// id,
	// @Valid @RequestBody ProductCategoryDTO productCategory,
	// BindingResult result) {
	...
	// productsCategoryService.retrieveById(id);
