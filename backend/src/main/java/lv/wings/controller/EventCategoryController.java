...
public class EventCategoryController {
	...
	@GetMapping(value = "")
	public ResponseEntity<ApiListResponse<EventCategory>> getAllCategories() {

		try {
			List<EventCategory> allEventCategories = eventCategoryRepo.retrieveAll();
			return ResponseEntity.ok(new ApiListResponse<>(null, allEventCategories));
	...
	public String postUpdateEventCategoryById(@PathVariable("id") int id, @Valid EventCategory eventCategory,
