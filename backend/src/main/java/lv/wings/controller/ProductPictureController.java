...
public class ProductPictureController {
	 ...
	 * try {
	 * ArrayList<ProductPicture> allProductPictures =
	 * productPictureService.retrieveAll();
	 ...
	 * {
	 * try {
	 * ProductPicture selectedProductPicture =
	 * productPictureService.retrieveById(id);
	 ...
	 * public String getDeleteProductPictureById(@PathVariable("id") int id, Model
	 * model) {
	 * try {
	 ...
	 * productPictureService.retrieveAll();
	 * model.addAttribute("mydata", allProductPictures);
	 * model.addAttribute("msg", "Visas preču bildes izņemot izdzēsto pēc id: " +
	 * id);
	 * return "preces-bilde-all-page";
	 * } catch (Exception e) {
	 * model.addAttribute("mydata", e.getMessage());
	 ...
	 * public String getInsertProductPicture(@PathVariable("precesid") int productId
	 * ,Model model) {
	 * try {
	 ...
	 * public String postInsertProductPicture(@PathVariable("precesid") int
	 * productId,
	 * 
	 ...
	 * return
	 * "redirect:/preces/bilde/show/all/"+productPicture.getProductPictureId();
	 * } catch (Exception e) {
	 * model.addAttribute("mydata", e.getMessage());
	 * return "msg-error-page";
	 * }
	 ...
	 * public String getUpdateProductPictureById(@PathVariable("id") int id, Model
	 * model) {
	 * try {
	 * ProductPicture productPictureForUpdating =
	 * productPictureService.retrieveById(id);
