		...
		<>
			...
			>
				...
				<ul className="mt-4">
					...
					<li className="mb-1 group">
						<Link
							to={"events-category/create"}
							className="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle"
						>
							<i className="bx bxl-blogger mr-3 text-lg"></i>
							<span className="text-sm">Izveidot kategoriju</span>
							<i className="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
						</Link>
					</li>
					<li className="mb-1 group">
			...
			<main
				...
				className={`size-full border-8 border-red-700 bg-gray-200 min-h-screen transition-all main ${toggle ? "" : "md:w-[calc(100%-256px)] md:ml-64"}`}
			>
				<div className="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-10">
					<button
