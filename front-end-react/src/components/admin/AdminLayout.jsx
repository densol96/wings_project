...
export default function AdminLayout() {
    ...
    <div className={`fixed left-0 top-0 w-64 h-full bg-[#f8f4f3] p-4 z-50 sidebar-menu  transition-transform ${toggle ? "-translate-x-full" : ""}`}>
        ...
        <ul className="mt-4">
            ...
            <li className="mb-1 group">
                ...
                <Link to={"events/add"} className="flex font-semibold items-center py-2 px-4 text-gray-900 hover:bg-gray-950 hover:text-gray-100 rounded-md group-[.active]:bg-gray-800 group-[.active]:text-white group-[.selected]:bg-gray-950 group-[.selected]:text-gray-100 sidebar-dropdown-toggle">
                <i className='bx bxl-blogger mr-3 text-lg' ></i>                 
                    <span className="text-sm">Izveidot</span>
                    <i className="ri-arrow-right-s-line ml-auto group-[.selected]:rotate-90"></i>
                </Link>
    ...
    <main onClick={handleHideSideNavBar} className={`w-full bg-gray-200 min-h-screen transition-all main ${toggle ? "" : "md:w-[calc(100%-256px)] md:ml-64"}`}>
       
        <div className="py-2 px-6 bg-[#f8f4f3] flex items-center shadow-md shadow-black/5 sticky top-0 left-0 z-30">
            <button onClick={handleToggleSideNavBar} type="button" className="text-lg text-gray-900 font-semibold sidebar-toggle">
                toggle button
            </button>
