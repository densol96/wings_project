...
export default function Navbar({pathName}) {
   const className = "block py-2 pr-4 pl-3 hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"
   if (pathName === "/news"){
    console.log("yes")
   }
  return (
      ...
      <div className="container flex flex-wrap justify-between items-center mx-auto">
        ...
        <div className="w-full md:block md:w-auto hidden" id="mobile-menu">
          <ul className="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium">
            <li>
              <Link
                className={pathName === "/" ? `${className} text-amber-500` : className}
                to="/"
              >
                Sākums
              </Link>
            ...
            <li>
              <Link
                className={pathName === "/news" ? `${className} text-amber-500` : className}
                to="/news"
              >
                Jaunumi
              </Link>
