...
import { HomeContent, Locale } from "@/types";
...
const Wallpaper = ({ homeDictionary, lang }: Props) => {
  return (
    <div className="relative overflow-hidden py-24 sm:py-32 my-4 px-6">
      <Image alt={homeDictionary.imageDescription} src={bg} className="absolute inset-0 -z-10 size-full object-cover object-right md:object-center" />
