...
import { AuditableSelect, Heading, SearchFilter } from "@/components";
      ...
      {products.length ? (
        <>
          <Table
            ...
            columnNames={["Nosaukums", "Daudzums", "Pārdots", "Izveidoja", "Izveidošanas datums", "Pēdējais rediģēja", "Pēdējās izmaiņas"]}
            data={products}
