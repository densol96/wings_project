...
public class AdminController {
	...
	public ResponseEntity<ApiResponse<?>> postCreateEventCategory(
			@Valid @RequestBody CreateEventCategoryDTO eventCategory,
	...
	public ResponseEntity<ApiResponse<?>> postCreateAndDeleteEventPicture(
			@Valid @RequestPart CreateEventPictureDTO eventPictureDTO,
	 ...
	 * public ResponseEntity<ApiResponse<EventPicture>>
	 * deleteEventPicture(@PathVariable int id) {
	 * try {
	 ...
	 * } catch (NoContentException e) {
	 * return ResponseEntity.ok(new ApiResponse<EventPicture>(e.getMessage(),
	 * null));
	 * } catch (Exception e) {
	 * return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).build();
	 * }
	 ...
	 * id, @Valid @RequestBody EventCategory eventCategory,
	 * BindingResult result) {
	 * 
	 * if (result.hasErrors()) {
	 * List<String> errors = result.getAllErrors()
